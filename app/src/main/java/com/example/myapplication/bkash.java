...
public class bkash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManagment sessionManagment = new SessionManagment(bkash.this);
    ...
    public void sendPost(String number,String usernumber, String ammount,String title, String pin,String account) throws IOException {
        ...
        call.enqueue(new Callback<loginModel>() {
            ...
            public void onResponse(Call<loginModel> call, Response<loginModel> response) {
                ...
                Toast.makeText(bkash.this, loginModel.getResponseoff(), Toast.LENGTH_SHORT).show();
                if(loginModel.getResponseoff().equals("send")){
                    Intent intent = new Intent(bkash.this,login.class);
            ...
            public void onFailure(Call<loginModel> call, Throwable t) {
                ...
                Toast.makeText(bkash.this, "Error" + t.getMessage().toString(), Toast.LENGTH_SHORT).show();
