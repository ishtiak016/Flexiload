...
public class nagad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManagment sessionManagment = new SessionManagment(nagad.this);
    ...
    public void sendPost(String number,String usernumber, String ammount,String title, String pin,String account) throws IOException {
        ...
        call.enqueue(new Callback<loginModel>() {
            ...
            public void onResponse(Call<loginModel> call, Response<loginModel> response) {
                ...
                Toast.makeText(nagad.this, loginModel.getResponseoff(), Toast.LENGTH_SHORT).show();
                if (loginModel.getResponseoff().equals("send")) {
                    Intent intent = new Intent(nagad.this, login.class);
            ...
            public void onFailure(Call<loginModel> call, Throwable t) {
                ...
                Toast.makeText(nagad.this, "Error" + t.getMessage().toString(), Toast.LENGTH_SHORT).show();
