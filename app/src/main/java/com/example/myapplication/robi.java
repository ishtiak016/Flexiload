...
public class robi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManagment sessionManagment = new SessionManagment(robi.this);
    ...
    public void sendPost(String number,String usernumber,String numbertype, String ammount,String title, String pin) throws IOException {
        ...
        call.enqueue(new Callback<loginModel>() {
            ...
            public void onResponse(Call<loginModel> call, Response<loginModel> response) {
                ...
                Toast.makeText(robi.this, loginModel.getResponseoff(), Toast.LENGTH_SHORT).show();
                if(loginModel.getResponseoff().equals("send")){
                    Intent intent = new Intent(robi.this,login.class);
            ...
            public void onFailure(Call<loginModel> call, Throwable t) {
                ...
                Toast.makeText(robi.this, "Error" + t.getMessage().toString(), Toast.LENGTH_SHORT).show();
