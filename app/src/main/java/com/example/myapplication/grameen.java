...
public class grameen extends AppCompatActivity {
RadioGroup category;
RadioButton rButton;
Button button;
TextView title;
...
private APIService grameenApi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManagment sessionManagment = new SessionManagment(grameen.this);
    ...
    public void sendPost(String number,String usernumber,String numbertype, String ammount,String title, String pin) throws IOException {
        ...
        call.enqueue(new Callback<loginModel>() {
            ...
            public void onResponse(Call<loginModel> call, Response<loginModel> response) {
                ...
                Toast.makeText(grameen.this, loginModel.getResponseoff(), Toast.LENGTH_SHORT).show();
                if(loginModel.getResponseoff().equals("send")){
                    Intent intent = new Intent(grameen.this,login.class);
            ...
            public void onFailure(Call<loginModel> call, Throwable t) {
                ...
                Toast.makeText(grameen.this, "Error" + t.getMessage().toString(), Toast.LENGTH_SHORT).show();
